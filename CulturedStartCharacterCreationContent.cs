...
namespace zCulturedStart
{
    public class CulturedStartCharacterCreationContent : SandboxCharacterCreationContent
    {
        ...
        public void AddQuestMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart03}Tutorial Skip (Default Quests)", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(DefaultQuestOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart04}Default start of the game, just without tutorial", null));
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart05}Neretzes' Folly Skip (Skips First Quest)", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(SkipQuestOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart06}Completes the first quest without talking to the quest nobles", null));
        ...
        public void AddStartMenu(CharacterCreation characterCreation)
        {
            ...
            // Exiled Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart13}A noble of {CULTURE} in exile", null), new TaleWorlds.Library.MBList<SkillObject> { DefaultSkills.Leadership }, null, 1, 10, 0, null, new CharacterCreationOnSelect(ExiledStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart14}Forced into exile after your parents were executed for suspected treason. With only your family's bodyguard you set off. Should you return you'd be viewed as a criminal.", null), null, 0, 150);

            // Mercenary Start            
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart15}In a failing mercenary company", null), new TaleWorlds.Library.MBList<SkillObject> { DefaultSkills.Tactics }, null, 1, 10, 0, null, new CharacterCreationOnSelect(MercenaryStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart16}With men deserting over lack of wages, your company leader was found dead, and you decided to take your chance and lead.", null), null, 0, 50);

            // Looter Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart17}A looter lowlife", null), new TaleWorlds.Library.MBList<SkillObject> { DefaultSkills.Roguery }, null, 1, 10, 0, null, new CharacterCreationOnSelect(LooterStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart18}Left impoverished from war, you found a group of like-minded ruffians who were desperate to get by.", null), null, 0, 0);

            // Vassal Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart19}A new vassal of {CULTURE}", null), new TaleWorlds.Library.MBList<SkillObject> { DefaultSkills.Steward }, null, 1, 10, 0, null, new CharacterCreationOnSelect(VassalStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart20}A young noble who came into an arrangement with the king for a chance at land.", null), null, 0, 150);

            // Kingdom Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart21}Leading part of {CULTURE}", null), new TaleWorlds.Library.MBList<SkillObject> { DefaultSkills.Leadership, DefaultSkills.Steward }, DefaultCharacterAttributes.Social, 1, 15, 1, null, new CharacterCreationOnSelect(KingdomStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart22}With the support of companions you have gathered an army. With limited funds and food you decided it's time for action.", null), null, 0, 900);

            // Holding Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart23}You acquired a castle", null), new TaleWorlds.Library.MBList<SkillObject> { DefaultSkills.Leadership, DefaultSkills.Steward }, DefaultCharacterAttributes.Social, 1, 15, 1, null, new CharacterCreationOnSelect(HoldingStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart24}You acquired a castle through your own means and declared yourself a kingdom for better or worse.", null), null, 0, 900);

            // Landed Vassal Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart25}A landed vassal of {CULTURE}", null), new TaleWorlds.Library.MBList<SkillObject> { DefaultSkills.Steward }, null, 1, 10, 0, null, new CharacterCreationOnSelect(LandedVassalStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart26}A young noble who came into an arrangement with the king for land.", null), null, 0, 150);

            // Escaped Prisoner Start
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart27}An escaped prisoner of a lord of {CULTURE}", null), new TaleWorlds.Library.MBList<SkillObject> { DefaultSkills.Roguery }, null, 1, 10, 0, null, new CharacterCreationOnSelect(EscapedStartOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart28}A poor prisoner of petty crimes who managed to break their shackles with a rock and fled.", null), null, 0, 0);
        ...
        public void AddLocationMenu(CharacterCreation characterCreation)
        {
            ...
            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart31}Near your home in the city where your journey began", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(HometownLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart32}Back to where you started", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart33}In a strange new city (Random)", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(RandomLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart34}Travelling far and wide you arrive at an unknown city", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart35}In a caravan to the Aserai city of Qasira", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(QasariLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart36}You leave the caravan right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart37}In a caravan to the Battania city of Dunglanys", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(DunglanysLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart36}You leave the caravan right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart38}On a ship to the Empire city of Zeonica", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(ZeonicaLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart39}You leave the ship and arrive right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart40}In a caravan to the Sturgia city of Balgard", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(BalgardLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart36}You leave the caravan right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart41}In a caravan to the Khuzait city of Ortongard", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(OrtongardLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart36}You leave the caravan right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart42}On a river boat to the Vlandia city of Pravend", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, null, new CharacterCreationOnSelect(PravendLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart43}You leave the boat and arrive right at the gates", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart44}At your castle", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, new CharacterCreationOnCondition(CastleLocationOnCondition), new CharacterCreationOnSelect(CastleLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart45}At your newly acquired castle", null), null);

            characterCreationCategory.AddCategoryOption(new TextObject("{=CulturedStart46}Escaping from your captor", null), new TaleWorlds.Library.MBList<SkillObject>(), null, 0, 0, 0, new CharacterCreationOnCondition(EscapingLocationOnCondition), new CharacterCreationOnSelect(EscapingLocationOnConsequence), new CharacterCreationApplyFinalEffects(DoNothingOnApply), new TextObject("{=CulturedStart47}Having just escaped", null), null);
